namespace Text_Caculator
{
    ...
    {
        //public static Dictionary<char, BaseBinaryOperationHandler> BinarySymbolToHandler;

        //public static Dictionary<string, BaseUnaryOperationHandler> UnarySymbolToHandler;
